...
export const scenarios = [
  ...
  },
  {
    ...
    narration: "Filtering by the token's groups claim — the access decision uses no Kong consumers (consumers exist only for analytics attribution). Each persona may call their own group's tools; frank (finance) may NOT call a dealer tool.",
    calls: [
